...
namespace MoreMountains.InventoryEngine
{
    ...
    public class ItemPicker : MonoBehaviour 
	{
        ...
        public virtual void Initialization(string playerID)
        {
		...
		public virtual void OnTriggerEnter2D (Collider2D collider) 
		{
            ...
            if (_targetInventory == null)
            {
                ...
                _targetInventory = Inventory.FindInventory(Item.TargetInventoryName, playerID);
				Debug.Log("还空吗" + (_targetInventory == null));
                Debug.Log("目标仓库：" + Item.TargetInventoryName);
            }
        ...
        /// 如果该物品可以被拾取，则返回 true，否则返回 false
        /// </summary>
