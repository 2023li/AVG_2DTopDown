...
namespace MoreMountains.Feedbacks
{
	...
	{
        public float TimeScale;                      // 目标时间缩放系数
        public float Duration;                       // 持续时间
        public bool TimeScaleLerp;                   // 是否启用插值
        public float LerpSpeed;                      // 插值速度
        public bool Infinite;                        // 是否无限持续
        public MMTimeScaleLerpModes TimeScaleLerpMode; // 插值模式
        public MMTweenType TimeScaleLerpCurve;       // 插值曲线
        public float TimeScaleLerpDuration;          // 插值持续时间
        public bool TimeScaleLerpOnReset;            // 重置时是否插值
        public MMTweenType TimeScaleLerpCurveOnReset;// 重置插值曲线
        public float TimeScaleLerpDurationOnReset;   // 重置插值持续时间
        public override string ToString() => $"请求参数：缩放={TimeScale} 时长={Duration} 插值={TimeScaleLerp} 速度={LerpSpeed} 持续={Infinite}";
    }
	...
	public class MMTimeManager : MMSingleton<MMTimeManager>
	{
        ...
        [MMLabel("是否更新Time.fixedDeltaTime")]
        ...
        [MMLabel("是否更新Time.maximumDeltaTime")]
