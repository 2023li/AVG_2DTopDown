...
namespace MoreMountains.Tools
{
    ...
    /// 
    /// 一个简单却强大的声音管理器，它能让你以基于事件的方式播放声音，同时兼顾性能。
    ///
    /// 功能特点：
    ///
    ///- 播放 / 停止 / 暂停 / 恢复 / 释放声音
    ///- 全面控制：循环、音量、音高、声像、空间混合、旁路、优先级、混响、多普勒级别、扩散、衰减模式、距离
    ///- 2D 和 3D 空间支持
    ///- 内置池化，自动回收一组音频源以实现最佳性能
    ///- 内置音频混音器和分组，配备现成的音轨（主音量、音乐、音效、用户界面），并可根据需要在更多分组上播放
    ///- 停止 / 暂停 / 恢复 / 释放整个音轨
    ///- 一次性停止 / 暂停 / 恢复 / 释放所有声音
    ///- 静音 / 设置整个音轨的音量
    ...
    ///- 声音淡入 / 淡出
    ///- 音轨淡入 / 淡出
    ///- 独奏模式：在静音一个或所有音轨的情况下播放声音，之后自动取消静音
    ///- PlayOptions 结构体
    ///- 支持声音在场景加载时以及场景切换时持续存在
    ///- 音轨的检查器控制（音量、静音、取消静音、播放、暂停、停止、恢复、释放、声音数量）
    ///- MMSfxEvents
    ///- MMSoundManagerEvents：静音音轨、控制音轨、保存、加载、重置、停止持续存在的声音
    /// </summary>
