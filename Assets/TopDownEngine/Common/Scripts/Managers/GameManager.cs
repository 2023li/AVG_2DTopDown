...
namespace MoreMountains.TopDownEngine
{
	...
	/// 
    /// /// 可能的自上而下引擎基础事件列表
    /// LevelStart：当关卡开始时由 LevelManager 触发
    /// LevelComplete：当到达关卡末尾时可以触发
    /// LevelEnd：同样的事情
    /// Pause：当暂停开始时触发
    /// UnPause：当暂停结束并恢复正常时触发
    /// PlayerDeath：当玩家角色死亡时触发
    /// RespawnStarted：当玩家角色重生序列开始时触发
    /// RespawnComplete：当玩家角色重生序列结束时触发
    /// StarPicked：当拾取星星奖励时触发
    /// GameOver：当所有生命耗尽时由 LevelManager 触发
    /// CharacterSwap：当角色被交换时触发
